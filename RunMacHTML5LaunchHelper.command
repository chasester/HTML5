...
EPIC_MONO=""
if [ -f "H:\Program Files\Epic Games\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "H:\Program Files\Epic Games\UE_4.22\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'H:\Program Files\Epic Games\UE_4.22\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
